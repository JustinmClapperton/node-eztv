...
describe('Parser', () => {
  describe('getShows()', () => {
    it('should return a Promise', async done => {
      expect(Parser.getShows('big bang')).to.be.a('promise');
      done();
    });

    it('should have expected properties', async done => {
      const results = await Parser.getShows('big bang');
  ...
  describe('getShowsEpisodes()', () => {
    it('should return a Promise', async done => {
      expect(Parser.getShowEpisodes('big bang')).to.be.a('promise');
      done();
    });

    it('should have expected properties', async done => {
      const results = await Parser.getShowEpisodes('big bang');
